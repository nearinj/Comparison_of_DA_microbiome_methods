...
parallel -j 45 "./Run_all_tools_fix2.sh -A $DATA_DIR/Studies/Office/Office_ASVs_table.tsv -G {1} -R $DATA_DIR/Studies/Office/Office_ASVs_table_rare.tsv -O $DATA_DIR/Studies/Office/False_Discovery_Testing/results_nonfilt_ext/{#} --ALDEX_SKIP T --CORNCOB_SKIP T --ANCOM_SKIP T" ::: $DATA_DIR/Studies/Office/False_Discovery_Testing/nonfilt_tabs/*.tsvext
