...
for (study in names(filt_study_tab$nonrare)) {
  ...
  unfilt_nonrare_ASV_aitchison <- parallelDist(x = t(unfilt_study_tab$nonrare[[study]][, unfilt_nonrare_samples]), method = "bray", threads = num_threads)
  ...
  unfilt_rare_ASV_aitchison <- parallelDist(x = t(unfilt_study_tab$rare[[study]][, unfilt_rare_samples]), method = "bray", threads = num_threads)
  ...
  filt_nonrare_ASV_aitchison <- parallelDist(x = t(filt_study_tab$nonrare[[study]][, filt_nonrare_samples]), method = "bray", threads = num_threads)
  ...
  filt_rare_ASV_aitchison <- parallelDist(x = t(filt_study_tab$rare[[study]][, filt_rare_samples]), method = "bray", threads = num_threads)
...
write.table(x = PERMANOVA_output,
            file = "/home/jacob/GitHub_Repos/Clean_Hackathon/Misc_datafiles/bray_permanova_results.tsv",
