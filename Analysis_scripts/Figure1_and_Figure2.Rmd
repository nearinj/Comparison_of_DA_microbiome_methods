...
colnames(fixed_hackathon_metadata)[which(colnames(fixed_hackathon_metadata) == "Log Max Read Depth")] <- "log(Max read depth)"
...
corrplot(filt_rhos_df[,-3], p.mat = filt_pvals_df[,-3], sig.level = 0.05, insig = "blank")
...
corrplot(as.matrix(unfilt_rhos_df[,-3]), p.mat = unfilt_pvals_df[,-3], sig.level = 0.05, insig = "blank")
