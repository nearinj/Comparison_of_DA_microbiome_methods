...
Metadata_renames <- c(log_N="Log Sample Size", R.squared="Aitchson's Dist. Effect Size", log_R.squared="Log Aitchson's Dist. Effect Size", Sparsity="Sparsity", Richness="Median Richness", log_Depth="Log Median Read Depth", log_Depth_range="Log Read Depth Range", CoV_Depth="Read Depth Variation")
```
