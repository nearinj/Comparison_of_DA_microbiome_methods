...
aitchison_permanova <- read.table("/home/gavin/projects/hackathon/21_04_7_PERMANOVA_results.tsv", header = TRUE, sep = "\t", row.names = 1)
...
fixed_hackathon_metadata_filt$Sparsity <- sort_filt_nonrare_metrics_df[,1]
fixed_hackathon_metadata_filt$Richness <- sort_filt_nonrare_metrics_df[,4]
fixed_hackathon_metadata_filt$log_Depth <- log(sort_filt_nonrare_metrics_df[,3])
fixed_hackathon_metadata_filt$log_Depth_range <- log(sort_filt_nonrare_metrics_df[,5])
fixed_hackathon_metadata_filt$CoV_Depth <- sort_filt_nonrare_metrics_df[,6]
...
colnames(fixed_hackathon_metadata_filt)[30:37] <- Metadata_renames[colnames(fixed_hackathon_metadata_filt[30:37])]

colnames(fixed_hackathon_metadata_filt)[which(colnames(fixed_hackathon_metadata_filt) == "Log Aitchson's Dist. Effect Size")] <- "log(Aitch. dist. effect size)"
colnames(fixed_hackathon_metadata_filt)[which(colnames(fixed_hackathon_metadata_filt) == "Log Read Depth Range")] <- "log(Read depth range)"
colnames(fixed_hackathon_metadata_filt)[which(colnames(fixed_hackathon_metadata_filt) == "Log Max Read Depth")] <- "log(Max read depth)"
colnames(fixed_hackathon_metadata_filt)[which(colnames(fixed_hackathon_metadata_filt) == "Read Depth Variation")] <- "Read depth variation"
colnames(fixed_hackathon_metadata_filt)[which(colnames(fixed_hackathon_metadata_filt) == "Log Sample Size")] <- "log(Sample size)"
...
fixed_hackathon_metadata_unfilt$Sparsity <- sort_unfilt_nonrare_metrics_df[,1]
fixed_hackathon_metadata_unfilt$Richness <- sort_unfilt_nonrare_metrics_df[,4]
fixed_hackathon_metadata_unfilt$log_Depth <- log(sort_unfilt_nonrare_metrics_df[,3])
fixed_hackathon_metadata_unfilt$Log_Depth_range <- log(sort_unfilt_nonrare_metrics_df[,5])
fixed_hackathon_metadata_unfilt$CoV_Depth <- sort_unfilt_nonrare_metrics_df[,6]
...
test <- Metadata_renames[colnames(fixed_hackathon_metadata_unfilt)[30:37]]

colnames(fixed_hackathon_metadata_unfilt)[30:37] <- Metadata_renames

colnames(fixed_hackathon_metadata_unfilt)[which(colnames(fixed_hackathon_metadata_unfilt) == "Log Aitchson's Dist. Effect Size")] <- "log(Aitch. dist. effect size)"
colnames(fixed_hackathon_metadata_unfilt)[which(colnames(fixed_hackathon_metadata_unfilt) == "Log Read Depth Range")] <- "log(Read depth range)"
colnames(fixed_hackathon_metadata_unfilt)[which(colnames(fixed_hackathon_metadata_unfilt) == "Log Max Read Depth")] <- "log(Max read depth)"
colnames(fixed_hackathon_metadata_unfilt)[which(colnames(fixed_hackathon_metadata_unfilt) == "Read Depth Variation")] <- "Read depth variation"
colnames(fixed_hackathon_metadata_unfilt)[which(colnames(fixed_hackathon_metadata_unfilt) == "Log Sample Size")] <- "log(Sample size)"
