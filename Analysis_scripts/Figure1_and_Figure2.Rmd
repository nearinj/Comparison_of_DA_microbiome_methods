...
write.table(x=order_raw_count_df, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure1_filt_sig_counts.csv", col.names = NA,
            row.names = T, quote=F, sep=",")

write.table(x=fixed_hackathon_metadata_filt, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure1_filt_dataset_char.csv", col.names = NA,
            row.names=T, quote=F, sep=",")
```
...
write.table(x=fix_raw_counts_unfilt, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure1_unfilt_sig_counts.csv", col.names = NA, 
            row.names = T, quote=F, sep=",")
write.table(x=fixed_hackathon_metadata_unfilt, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure1_unfilt_dataset_char.csv", col.names=NA,
            row.names=T, quote=F, sep=",")
...
write.table(x=filt_rhos_df, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure2_filt.csv", col.names = NA,
            row.names = T, quote=F, sep=",")
...
write.table(x=unfilt_rhos_df, file = "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure2_unfilt.csv", col.names = F,
            row.names = T, quote=F, sep=",")
