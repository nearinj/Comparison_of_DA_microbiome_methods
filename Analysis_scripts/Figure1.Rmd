...
opts_knit$set(root.dir = '/home/jacob/projects/TEST_DA_TEST2/Hackathon/Studies/')
...
saveRDS(filt_results, "~/GitHub_Repos/Hackathon_testing/Data/Filt_results_TEST_DA_TEST2.RDS")
saveRDS(unfilt_results, "~/GitHub_Repos/Hackathon_testing/Data/Unfilt_results_TEST_DA_TEST2.RDS")
...
saveRDS(unfilt_study_tab, "~/GitHub_Repos/Hackathon_testing/Data/unfilt_study_tab_TEST_DA_TEST2.RDS")
saveRDS(filt_study_tab, "~/GitHub_Repos/Hackathon_testing/Data/filt_study_tab_TEST_DA_TEST2.RDS")
```
...
## Read in data
```{r}
filt_results <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/Filt_results_TEST_DA_TEST2.RDS")
unfilt_results <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/Unfilt_results_TEST_DA_TEST2.RDS")

unfilt_study_tab  <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/unfilt_study_tab_TEST_DA_TEST2.RDS")
filt_study_tab <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/filt_study_tab_TEST_DA_TEST2.RDS")
...
## Final Plot
```{r}
final_plot <- gridExtra::grid.arrange(unfilt_ASV_nums[[4]], filt_ASV_nums[[4]], nrow=2)
final_plot
```