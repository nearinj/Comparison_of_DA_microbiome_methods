...
ArcticFreshWater_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/ArcticFreshwaters/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/ArcticFreshwaters_ASVs_table.tsv")

Blueberry_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/Blueberry/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/Blueberry_ASVs_table.tsv")

ob_goodrich_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/ob_goodrich/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/ob_goodrich_ASVs_table.tsv")

hiv_noguerajulian_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/hiv_noguerajulian/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/hiv_noguerajulian_ASVs_table.tsv")

Ji_WTP_DS_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/Ji_WTP_DS/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/Ji_WTP_DS_ASVs_table.tsv")

Office_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/Office/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/Office_ASVs_table.tsv")

cdi_schubert_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/cdi_schubert/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/cdi_schubert_ASVs_table.tsv")

sw_sed_detender_unfilt_tab <- read_in_table("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/sw_sed_detender/False_Discovery_Testing/results_nonfilt/1/fixed_non_rare_tables/sw_sed_detender_ASVs_table.tsv")


## load in groupings for each dataset....
ArcticFreshWaters_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/ArcticFreshwaters/False_Discovery_Testing/nonfilt_tabs/")
Blueberry_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/Blueberry/False_Discovery_Testing/nonfilt_tabs/")
ob_goodrich_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/ob_goodrich/False_Discovery_Testing/nonfilt_tabs/")  
hiv_noguerajulian_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/hiv_noguerajulian/False_Discovery_Testing/nonfilt_tabs/")
Ji_WTP_DS_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/Ji_WTP_DS/False_Discovery_Testing/nonfilt_tabs/")
Office_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/Office/False_Discovery_Testing/nonfilt_tabs/")
cdi_schubert_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/cdi_schubert/False_Discovery_Testing/nonfilt_tabs/")
sw_sed_detender_groupings <- read_in_groupings("~/projects/HACKATHON_ANCOM_FIX_21_03_13/Hackathon/Studies/sw_sed_detender/False_Discovery_Testing/nonfilt_tabs/")
...
```{r}
## calculate the difference in read depth between the two groupings
...
plot_data[[7]] <- data.frame(FP_class=cdi_schubert_FP_class,
                             ...
                             dataset="cdi schubert")

plot_data[[8]] <- data.frame(FP_class=sw_sed_detender_FP_class,
                             depth_diff=sw_sed_detender_diffs,
                             dataset="SW Sed Detender")


total_plot_data <- do.call(rbind, plot_data)

library(ggplot2)
scatter_FP_res <- ggplot(total_plot_data, aes(x=depth_diff, y=FP_class.Raw_FP_per)) + geom_point() + xlab("Relative difference in read depth") +
...
box_FP_res <- ggplot(total_plot_data, aes(x=FP_class.FP_class, y=depth_diff)) + geom_boxplot() + xlab("FP >= 30%") +
  ylab("Mean Difference in Read Depth") + facet_grid(cols=vars(total_plot_data$FP_class.Tool), rows=vars(total_plot_data$dataset)) + geom_beeswarm() +
  theme_bw()

box_FP_res


ggsave(filename=paste(display_items_out, "Supp_figures", "Read_depth_FP_analysis.pdf", sep="/"),
       plot = box_FP_res, width = 12, height=10, units="in", dpi=600)


ggsave(filename=paste(display_items_out, "Supp_figures", "Read_depth_FP_analysis.png", sep="/"),
