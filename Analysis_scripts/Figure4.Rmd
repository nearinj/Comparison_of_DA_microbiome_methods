...
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/Office/False_Discovery_Testing/results_filt/")
...
#### ArcticFreshWaters
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/ArcticFreshwaters/False_Discovery_Testing/results_filt/")
...
#### Blueberry
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/Blueberry/False_Discovery_Testing/results_filt/")
...
#### Goodrich
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/ob_goodrich/False_Discovery_Testing/results_filt/")
...
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/hiv_noguerajulian/False_Discovery_Testing/results_filt/")
...
#### Ji_WTP_DS
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/Ji_WTP_DS/False_Discovery_Testing/results_filt/")
...
#### Schubert
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/cdi_schubert/False_Discovery_Testing/results_filt/")
...
#### sw_sed_detender
```{r}
setwd("~/projects/TEST_DA_TEST2/Hackathon/Studies/sw_sed_detender/False_Discovery_Testing/results_filt/")
...
#### Save list
```{r}
saveRDS(Filtered_FD_data, "~/GitHub_Repos/Hackathon_testing/Data/FD_data_filt_TEST_DA_TEST2.RDS")
```
...
#### Filtered
```{r}
Filtered_FD_data <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/FD_data_filt_TEST_DA_TEST2.RDS")
...
final_final_plot <- cowplot::plot_grid(Final_heat_nonfilt[[4]], final_plot[[4]], nrow=2, labels = c("A", "B"))
final_final_plot
```
