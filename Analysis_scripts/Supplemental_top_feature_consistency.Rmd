...
generate_consist_occur <- function(count_df){
  ...
  colnames(ret_data_df) <- c("Consistancy", "Count", "Tool")
  return(ret_data_df)
}
...
means <- aggregate(filt_comp_tab$Count, by=list(filt_comp_tab$Consistancy, filt_comp_tab$Tool), FUN=mean)
View(means)
```
...
means <- aggregate(unfilt_comp_tab$Count, by=list(unfilt_comp_tab$Consistancy, unfilt_comp_tab$Tool), FUN=mean)
View(means)
```
