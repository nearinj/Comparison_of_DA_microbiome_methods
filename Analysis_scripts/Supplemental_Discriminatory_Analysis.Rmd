...
write.table(x=filt_heat_data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/Supplemental_AUROC_heatmap_filt_RA.csv", col.names = NA,
...
write.table(x=filt_heat_data_CLR, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/Supplemental_AUROC_heatmap_filt_CLR.csv", col.names = NA,
            row.names = T, quote=F, sep=",")
```
...
write.table(x=plot_07$data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_RA_07.csv", col.names = NA, 
            row.names = T, quote=F, sep=",")
```
...
write.table(x=plot_09$data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_RA_09.csv", col.names = NA,
            row.names = T, quote=F, sep=",")
...
#write csv used to plot data
write.table(x=plot_07_CLR$data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_CLR_07.csv",  col.names = NA,
            row.names = T, quote=F, sep=",")
```
...
#write plotting data
write.table(x=plot_09_CLR$data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_CLR_09.csv", col.names = NA,
            row.names = T, quote=F, sep=",")
```
...
ggsave(filename=paste(display_items_out, "Supp_figures", "Supplemental_AUROC_F1_unfilt.pdf", sep="/"),
       plot = final_sup_fig_unfilt, width = 9, height=13, units="in", dpi=600)

ggsave(filename=paste(display_items_out, "Supp_figures", "Supplemental_AUROC_F1_unfilt.png", sep="/"),
