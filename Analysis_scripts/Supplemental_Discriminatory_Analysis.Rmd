...
write.csv2(filt_heat_data, "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/Supplemental_AUROC_heatmap_filt_RA.csv")
```
...
write.csv2(filt_heat_data_CLR, "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/Supplemental_AUROC_heatmap_filt_CLR.csv")
```
...
write.csv2(plot_07$data, "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_RA_07.csv")
```
...
write.csv2(plot_09$data, "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_RA_09.csv")
...
#write csv used to plot data
write.csv2(plot_07_CLR$data, "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_CLR_07.csv")
```
...
#write plotting data
write.csv2(plot_09_CLR$data, "~/GitHub_Repos/Clean_Hackathon/Plotting_data/Supp_figures/AUC_boxplots_CLR_09.csv")
```
