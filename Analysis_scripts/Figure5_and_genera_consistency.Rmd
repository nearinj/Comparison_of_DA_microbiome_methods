...
```{r read_RDS}
diarrhea_outputs_binary_clean_combined <- readRDS(file =                                           "/home/gavin/projects/hackathon/consistency_analysis_RDS_out/diarrhea_outputs_binary_clean_combined.rds")

diarrhea_combined_overlap <- readRDS(file = "/home/gavin/projects/hackathon/consistency_analysis_RDS_out/diarrhea_combined_overlap.rds")

obesity_outputs_binary_clean_combined <- readRDS(file = "/home/gavin/projects/hackathon/consistency_analysis_RDS_out/obesity_outputs_binary_clean_combined.rds")

obesity_combined_overlap <- readRDS(file = "/home/gavin/projects/hackathon/consistency_analysis_RDS_out/obesity_combined_overlap.rds")
...
```{r diarrhea_observed_vs_expected_ks}
 ...
 diarrhea_ks_out <- data.frame(matrix(NA, nrow=ncol(diarrhea_outputs_binary_clean_summed), ncol=8))
  ...
  if(length(which(diarrhea_ks_out[, "P"] < 0.0001)) > 0) {
    diarrhea_ks_out[which(diarrhea_ks_out[, "P"] < 0.0001), "P"] <- "< 1e-4"
  }
