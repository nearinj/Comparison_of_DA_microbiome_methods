...
write.table(x = obesity_combined_overlap_obs,
            file = "/home/gavin/github_repos/hackathon/Comparison_of_DA_microbiome_methods/Plotting_data/Supp_figures/SuppTable3_genera_obesity_observed_consistency.csv",
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = ",")
...
write.table(x = obesity_combined_overlap_expected,
            file = "/home/gavin/github_repos/hackathon/Comparison_of_DA_microbiome_methods/Plotting_data/Supp_figures/SuppTable3_genera_obesity_expected_consistency.csv",
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = ",")
