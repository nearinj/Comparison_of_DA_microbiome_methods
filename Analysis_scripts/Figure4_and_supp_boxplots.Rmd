...
#write plotting data
write.table(x=unfilt_percent_sig_boxplots$data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure4_FDR_boxplots_unfilt.csv", col.names = NA,
            row.names=T, quote=F, sep=",")

write.table(x=unfilt_percent_sig_boxplots$data, file="~/GitHub_Repos/Clean_Hackathon/Plotting_data/Main_Figures/Figure4_FDR_boxplots_filt.csv", col.names = NA,
            row.names=T, quote=F, sep=",")
...
ggsave(filename=paste(display_items_out, "Main_figures", "FDR_boxplots_Figure4.png", sep="/"),
       plot = New_Figure4, width = 10, height=10, units="in", dpi=300)

ggsave(filename=paste(display_items_out, "Main_figures", "FDR_boxplots_Figure4.pdf", sep="/"),
