...
## need to rerun aldex due to running out of memory when it ran originally...
## the following runs:
# 11 (done)
# 12 (done)
# 24  (done)
...
# 72 (done)
# 73 (done)
# 74 (done), 75 (done), 76 (done), 77 (done), 78 (done), 79 (done), 80 (done), 81 (done), 82 (done), 83 (done), 84 (done), 85 (done), 86 (done), 87 , 88, 89
