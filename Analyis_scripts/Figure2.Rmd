...
#saveRDS(Feature_count_tab_filt, "~/GitHub_Repos/Hackathon_testing/Data/Feature_count_tab_filt.RDS")
Feature_count_tab_filt <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/Feature_count_tab_filt.RDS")
...
#saveRDS(Feature_count_tab_unfilt, file="~/GitHub_Repos/Hackathon_testing/Data/Feature_count_tab_unfilt.RDS")
Feature_count_tab_unfilt <- readRDS("~/GitHub_Repos/Hackathon_testing/Data/Feature_count_tab_unfilt.RDS")
...
### change name of variables for plotting.
tool_names <- names(table(merged_no_zero_unfilt$variable))
